...
<body>
	...
	<div id="divMain" class="tplCont">
		...
		<div class="blockContent">
			...
			<div class="blockContentInner">
				...
				<div class="textBlock">
					<!--<img src="/img/pic/ya_map.jpg" width="1068" height="728" />-->
					<?
					include 'blocks/shop.contact.php';
					?>
	...
	<div id="bg" class="bgMain"><img src="/img/tpl/bg_contacts.jpg" width="100%" height="100%" /></div>
</body>
</html>
