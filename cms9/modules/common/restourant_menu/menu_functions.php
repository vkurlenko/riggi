...
function GetNews($news_table_name)
{
	...
	if($res)
	{
		...
		{
			echo "<tr>\n";
			echo "<td>[<a style='color:red' href=?page=restourant_menu_volumes&del_news&id=".$row['id'].">X</a>]</td><td>[ ".$row['news_date']." ]</td><td><b>".$row['news_title']."</b></td>
			<td><a href=?page=restourant_menu_volumes&edit_news&id=".$row['id'].">edit</a></td>\n";
			echo "</tr>\n";
		}
		echo "</table>\n";
	}
...
function GetMenuPos($news_table_name)
{
	...
	if($res)
	{
		...
		{
			echo "<tr>\n";
			echo "<td>[<a style='color:red' href=?page=restourant_menu_volumes&del_news&id=".$row['id'].">X</a>]</td><td><b>".$row['news_title']."</b></td>
			<td><a href=?page=restourant_menu_volumes&edit_news&id=".$row['id'].">edit</a></td>\n";
			echo "</tr>\n";
		}
		echo "</table>\n";
